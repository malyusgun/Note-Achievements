...
}), D2 = ["width", "height"], R2 = ["fill"], O2 = ["fill"], F2 = /* @__PURE__ */ h({
  __name: "ArchiveIcon",
  props: {
    color: {},
    size: {}
...
}), ye = ["width", "height"], Me = ["fill"], Ve = ["fill"], He = ["fill"], Ie = ["fill"], Ze = /* @__PURE__ */ h({
  __name: "BanknoteIcon",
  props: {
    color: {},
    size: {}
...
}), Oe = ["width", "height"], Fe = ["fill"], We = /* @__PURE__ */ h({
  __name: "BoxIcon",
  props: {
    color: {},
    size: {}
...
}), t0 = ["width", "height"], n0 = ["fill"], r0 = ["fill"], s0 = ["fill"], i0 = ["fill"], a0 = ["fill"], u0 = ["fill"], d0 = /* @__PURE__ */ h({
...
}), L0 = ["width", "height"], z0 = ["fill"], y0 = ["fill"], M0 = ["fill"], V0 = ["fill"], H0 = /* @__PURE__ */ h({
  __name: "CardsIcon",
  props: {
    color: {},
    size: {}
...
}), a5 = ["width", "height"], u5 = ["fill"], d5 = ["fill"], c5 = ["fill"], C5 = ["fill"], p5 = ["fill"], h5 = ["fill"], f5 = ["fill"], v5 = /* @__PURE__ */ h({
...
}), R5 = ["width", "height"], O5 = ["fill"], F5 = /* @__PURE__ */ h({
  __name: "CupIcon",
  props: {
    color: {},
    size: {}
...
}), t3 = ["width", "height"], n3 = ["fill"], r3 = ["fill"], s3 = ["fill"], i3 = ["fill"], a3 = ["fill"], u3 = ["fill"], d3 = ["fill"], c3 = ["fill"], C3 = /* @__PURE__ */ h({
  __name: "DiceIcon",
  props: {
    color: {},
    size: {}
...
}), D3 = ["fill", "width", "height"], R3 = ["fill"], O3 = /* @__PURE__ */ h({
...
}), F3 = ["width", "height"], W3 = ["fill"], U3 = ["fill"], q3 = /* @__PURE__ */ h({
  __name: "DownloadIcon",
  props: {
    color: {},
    size: {}
...
}), w4 = ["width", "height"], $4 = ["fill"], _4 = ["fill"], b4 = ["fill"], k4 = ["fill"], L4 = ["fill"], z4 = /* @__PURE__ */ h({
  __name: "FeedbackIcon",
  props: {
    color: {},
    size: {}
...
}), V4 = ["width", "height"], H4 = ["fill"], I4 = ["fill"], Z4 = ["fill"], B4 = ["fill"], S4 = ["fill"], x4 = ["fill"], T4 = ["fill"], P4 = ["fill"], A4 = /* @__PURE__ */ h({
...
}), D4 = ["width", "height"], R4 = ["fill"], O4 = /* @__PURE__ */ h({
  __name: "FireIcon",
  props: {
    color: {},
    size: {}
...
}), F4 = ["width", "height"], W4 = ["fill"], U4 = /* @__PURE__ */ h({
  __name: "FlagIcon",
  props: {
    color: {},
    size: {}
...
}), no = ["width", "height"], ro = ["fill"], so = ["fill"], io = ["fill"], ao = ["fill"], uo = /* @__PURE__ */ h({
...
}), co = ["width", "height"], Co = ["fill"], po = ["fill"], ho = ["fill"], fo = ["fill"], vo = ["fill"], mo = ["fill"], go = /* @__PURE__ */ h({
...
}), Ao = ["width", "height"], Do = ["fill"], Ro = ["fill"], Oo = ["fill"], Fo = /* @__PURE__ */ h({
  __name: "ImageIcon",
  props: {
    color: {},
    size: {}
...
}), R9 = ["width", "height"], O9 = ["fill"], F9 = ["fill"], W9 = /* @__PURE__ */ h({
  __name: "UserIcon",
  props: {
    color: {},
    size: {}
...
const y7 = (l) => {
...
}, V = (l, e = "500") => l in D1 ? e === "500" ? j1(l) : e === "100" ? y7(l) : e === "200" ? M7(l) : e === "300" ? V7(l) : e === "400" ? H7(l) : e === "600" ? I7(l) : e === "700" ? Z7(l) : e === "800" ? B7(l) : e === "900" ? S7(l) : j1(l) : l, s1 = (l, e = "500") => l === "white" || e <= "600" && l !== "black" ? "#000000" : "#ffffff", x7 = (l, e) => {
  if (l === "white") {
...
}, p1 = (l, e = "500") => l === "white" || l === "black" ? x7(l, e) : V(l, String(100 + (+e + 600) % 900)), e1 = (l, e) => l === "normal" ? e[1] : l === "large" ? e[2] : l === "huge" ? e[3] : e[0], T7 = { class: "modalHeader" }, P7 = { class: "main" }, A7 = /* @__PURE__ */ h({
  __name: "Modal",
  props: /* @__PURE__ */ F({
    theme: { default: "white" },
    textColor: {},
  ...
  emits: /* @__PURE__ */ F(["update"], ["update:modelValue"]),
  setup(l, { emit: e }) {
    o1((_) => ({
      "25a516d2": w.value
    }));
    ...
    return (_, r) => (n(), s("button", {
      style: b(`width: ${g.value.containerWidth}px; height: ${g.value.containerHeight}px; border-radius: ${g.value.borderRadius}px; padding: ${g.value.padding}px; cursor: ${_.disabled ? "auto" : "pointer"}`),
      class: "switcher",
  ...
  emits: /* @__PURE__ */ F(["onClick"], ["update:modelValue"]),
  setup(l, { emit: e }) {
    o1((m) => ({
      a84524aa: g.value,
      "859a1b36": p.value
  ...
  props: /* @__PURE__ */ F({
    ...
    options: {},
    isValueEqualOption: { type: Boolean }
  }, {
    modelValue: {},
    modelModifiers: {}
  }),
  ...
  setup(l) {
    ...
    ), a = u(() => p1(e.theme, e.darknessTheme)), C = u(() => e.width ? e.width : "max-content"), v = u(() => {
      switch (e.size) {
        case "small":
          return "12px";
        case "large":
    ...
    return (g, _) => (n(), s("div", J7, [
      t("button", {
        ...
        }, O(g.label ? g.label : g.iconOnly ? "" : "Button"), 7)) : T("", !0),
  ...
  setup(l) {
    ...
    }), g = (r, p) => window.open(r, p ? "_blank" : "_self"), _ = (r) => r.color ? V(r.color, r.darknessColor) : r.theme === "white" || +(r.darknessTheme ?? "500") <= 600 && r.theme !== "black" ? "black" : "white";
    return (r, p) => (n(), s("section", el, [
      t("button", {
  ...
  const o = isFinite(+e[e.length - 3]), i = o ? e.slice(0, -2) : e.slice(0, -3), a = o ? e.slice(-2) : e.slice(-3);
  return l === "large" ? +i / 2 + a : l === "huge" ? i + a : -+i / 4 + a;
}, ul = (l, e, o) => e ? `0px calc(${o} / 2 + ${l.padding ?? "0px"} / 2)` : `0 ${l.padding ?? "0px"} 0 0`, N1 = (l) => {
  if (!l) return null;
  const { active: e, ...o } = l;
  return o;
...
} : l, dl = { class: "columnHeader-container" }, cl = ["onClick"], Cl = ["onPointerdown", "id"], pl = { key: 0 }, hl = { style: { padding: "2px" } }, fl = { class: "filterButtons" }, vl = { style: { width: "50px", "font-size": "20px" } }, ml = /* @__PURE__ */ h({
  __name: "TableHeader",
  props: /* @__PURE__ */ F({
    table: {},
    columns: {},
  ...
  emits: /* @__PURE__ */ F(["changeColumnSortMode", "setFilter", "cancelFilter"], ["update:filterValue", "update:isFilterPopup", "update:isRegisterSensitive"]),
  setup(l, { emit: e }) {
    o1((r) => ({
      "3287e180": r.secondaryColor
    }));
    const o = l, i = e, a = N(l, "filterValue"), C = N(l, "isFilterPopup"), v = N(l, "isRegisterSensitive"), w = u(() => {
    ...
    return (r, p) => (n(), s("tr", null, [
      (n(!0), s(j, null, Y(r.columns, (f, c) => (n(), s("th", {
        ...
        t("div", {
          style: b(`justify-content: ${r.center ? "center" : "start"}; gap: ${r.center ? "0" : r.initGap}; padding: ${A(ul)(f, r.center, r.initGap)}`),
          class: "columnFlex"
        }, [
          t("div", dl, [
  ...
  setup(l) {
    ...
    ), w = u(() => e1(e.size, ["12px", "16px", "20px", "24px"])), g = u(() => e1(e.size, ["3px 7px", "5px 11px", "6px 13px", "7px 16px"]));
    function _(r) {
      i.value = !0;
  ...
  return e;
}, kl = (l) => l === "normal" ? "16px" : l === "large" ? "20px" : l === "huge" ? "24px" : "12px", Ll = (l) => l === "normal" ? "6px" : l === "large" ? "10px" : l === "huge" ? "14px" : "4px", zl = ["name"], yl = ["selected"], Ml = /* @__PURE__ */ h({
  __name: "Select",
  props: /* @__PURE__ */ F({
              ...
              font-size: calc(${r.value} * 0.8); padding: calc(${p.value} * 0.8)`)
                ...
                (n(!0), s(j, null, Y(d.items, (B) => (n(), P(H1, {
                  ...
                  class: Z([
                    "flex",
                    {
                      firstOption: M.options[0].value === B.value,
                      lastOption: M.options[M.options.length - 1].value === B.value
                    }
                  ]),
                  style: b(`color: ${D(B.color, B.darknessColor, $.value)};
            background-color: ${D(B.background, B.darknessBackground, L.value)}`)
                }, {
                  default: R(() => [
                    W(M.$slots, `icon-left-${B.value}`, {}, void 0, !0),
                    t("span", {
                      class: "text",
                      style: b(`font-size: ${r.value}`)
                    }, O(B.label ?? B.value), 5),
                    W(M.$slots, `icon-right-${B.value}`, {}, void 0, !0)
                  ]),
                  _: 2
...
}, Pl = (l) => l === "normal" ? "100px" : l === "large" ? "150px" : l === "huge" ? "200px" : l === "giant" ? "300px" : "70px", Al = /* @__PURE__ */ h({
  __name: "Knob",
  props: /* @__PURE__ */ F({
    value: {},
    min: { default: 0 },
...
}), Xl = ["width", "height"], Yl = ["stroke"], Kl = ["stroke"], Jl = ["stroke"], Ql = ["stroke"], e8 = /* @__PURE__ */ h({
  ...
  setup(l) {
    ...
    const a = u(() => Math.ceil(e.total / i.value)), C = u(() => Array.from({ length: a.value }, ($, k) => k + 1)), v = u(
  ...
  emits: /* @__PURE__ */ F(["updateData"], ["update:modelValue"]),
  setup(l, { emit: e }) {
    o1((I) => ({
      "6c81dda6": I.fontSize,
      d2391526: x.value,
    ...
    const k = u(() => il(o.gap ?? "5px", o.fontSize)), L = u(() => al(o.size, o.fontSize)), H = u(() => {
      const I = [];
              ...
              (n(!0), s(j, null, Y(K, (V1, d1) => {
                ...
                return n(), s("td", {
                  ...
                  class: Z({
                    ...
                    noEdit: !g.value || ((b1 = I.noEditingSettings) == null ? void 0 : b1.columns) && ~((O1 = I.noEditingSettings.columns) == null ? void 0 : O1.indexOf(d1)),
                    pointer: I.handlers && ((F1 = I.handlers) == null ? void 0 : F1.find((v1) => {
                      var c1, h1;
...
], g8 = { class: "carouselContainer" }, w8 = { style: { "text-align": "center", "margin-bottom": "10px" } }, $8 = {
  key: 0,
  class: "buttons"
}, _8 = /* @__PURE__ */ h({
  __name: "Carousel",
  ...
  setup(l) {
    ...
    const w = S(), g = S(!1), _ = u(() => e.theme ?? o[e.type]), r = u(() => e.header ?? i[e.type]), p = u(() => e.icon ?? a[e.type]), f = u(
      () => V(
    ...
    ), D = u(() => k.value.slice(0, -2)), M = u(() => +D.value + +H.value.slice(0, -2) + "px"), x = u(() => "-" + document.body.clientHeight + "px"), U = u(() => {
      const J = [];
    ...
    return X(C, () => {
      ...
      t("h3", {
        ...
        t("span", k8, O(r.value), 1)
      ], 4),
      t("p", L8, O(J.text ?? `This is a toast about ${J.type}`), 1),
      y(w1, {
        onClick: B,
  ...
  return o;
}, I8 = { class: "list" }, Z8 = ["onInput", "onKeydown", "type"], B8 = { class: "list" }, S8 = ["onInput", "onKeydown", "type"], x8 = /* @__PURE__ */ h({
  __name: "InputDiv",
  props: /* @__PURE__ */ F({
    scheme: { default: "4by1" },
    size: { default: "normal" },
  ...
  setup(l) {
    ...
    ], a = S(!1), C = () => console.log("close!"), v = S(), w = S(!1), g = S(!1), _ = S(!1), r = S(1), p = [
      {
        name: "Name",
        type: "text"
      },
  ...
  setup(l) {
    ...
    return (r, p) => (n(), s("div", F8, [
      r.buttonProps ? (n(), P(O8, t1({ key: 0 }, r.buttonProps, {
